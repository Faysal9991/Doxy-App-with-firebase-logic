...
class PhoneNumberPicker extends StatefulWidget {
  PhoneNumberPicker({Key? key, required this.phone}) : super(key: key);
...
class _PhoneNumberPickerState extends State<PhoneNumberPicker> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(body: ListTile(title: buildCountryPickerDropdown()));
  }

  buildCountryPickerDropdownSoloExpanded() {
  ...
  buildCountryPickerDropdown(
      {bool sortedByIsoCode = true, bool hasSelectedItemBuilder = false}) {
