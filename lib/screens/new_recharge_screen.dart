                                        ...
                                        Padding(
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              Text(
                                                  "নিচে দেওয়া নাম্বারটি পার্সোনাল নাম্বার।\n নাম্বার টি কপি করে সেন্ড মানি করুন",
                                                  style: GoogleFonts.lato(
                                                      color: Colors.black,
                                                      fontSize: 10,
                                                      fontWeight:
                            ...
                            builder: (ctx) => StreamBuilder<MainAdminModel>(
                                ...
                                builder: (context, snap) {
                                  if (snap.hasData) {
                                    return AlertDialog(
                                      title:
                                          const Text("Rocket Deposit option"),
                                      actions: [
                                        Padding(
                                          padding: const EdgeInsets.all(8.0),
                                          child: Column(
